...
--[dbo].sp_GetReleasedWithCustomer 'ALPHA', 0,50,'',''  
...
-- =============================================
CREATE PROCEDURE [dbo].sp_GetReleasedWithCustomer   
@custName AS nvarchar(25) = null,  
@startRecord int,  
@endRecord int,   
...
;WITH packingList AS(  
 ...
 AND NOT PRINT_INVO=1 AND CHARINDEX(@CUSTNAME ,UPPER(CUSTNAME))>0   
 AND PRINTED=1 )  
--Sachin S-05-16-2016:Get the filtered list based on the column and fifty records at a time  
