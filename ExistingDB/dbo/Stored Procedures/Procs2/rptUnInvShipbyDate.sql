...
-- Description:	This Stored Procedure was created for the Un-Invoiced Shipment Summary by Date report
-- Reports Using Stored Procedure:  inv_rep4.rpt
...
-- =============================================
CREATE PROCEDURE [dbo].[rptUnInvShipbyDate]
--declare
...
IF @lFCInstalled = 0
	...
	WHERE	INVDATE >=@lcDateStart AND INVDATE<@lcDateEnd+1
			and plmain.IS_INVPOST = 0
