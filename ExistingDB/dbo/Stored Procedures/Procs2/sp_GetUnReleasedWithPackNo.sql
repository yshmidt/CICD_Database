...
-- Description:	get packing list get unreleased with pack number
...
--[dbo].sp_GetUnReleasedWithPackNo  '0000000052',0,20,'',''
-- ==========================================================================================
CREATE PROCEDURE [dbo].sp_GetUnReleasedWithPackNo 
...
;WITH packingList as(
   --Sachin S-05-16-2016 Change the order of columns as discussed in Call
	...
	AND NOT PRINT_INVO = 1 AND CHARINDEX(@packListNo ,UPPER(PACKLISTNO))>0 
	AND NOT PRINTED=1 
)
--Sachin S-05-16-2016:Get the filtered list based on the column and fifty records at a time
