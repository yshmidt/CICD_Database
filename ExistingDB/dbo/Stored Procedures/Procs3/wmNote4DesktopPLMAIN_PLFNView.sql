...
-- Description:	Get packing list foot note from wmNotes and wmNoteRelationship, but only get the latest one because didn't re-write to create several records for same note
-- =============================================
CREATE PROCEDURE [dbo].[wmNote4DesktopPLMAIN_PLFNView] 
...
BEGIN
	...
	SELECT TOP 1 RecordId, wmNoteRelationship.*
		...
		WHERE wmNotes.RecordType = 'PLMAIN_PLFN'
