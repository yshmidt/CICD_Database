CREATE PROCEDURE [dbo].[GetMSL4WO_WC] 
...
BEGIN
	...
	isnull(sum(iu.qtyallocated),0.00) as sumUnalloc,ir.KaSeqnum,r.UNIQ_KEY,r.W_KEY,q.UNIQMFGRHD,m.MfgrMasterId
	...
	r.UNIQ_KEY,r.W_KEY,q.UNIQMFGRHD,m.MfgrMasterId,m.MOISTURE
