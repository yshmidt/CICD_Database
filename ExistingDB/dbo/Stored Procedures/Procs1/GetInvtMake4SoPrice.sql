...
--				used as a source for 'invtMakePart4SoPrice' sourcename in mnxParamSources  (rptSalesPriceList - partlist) 
--- Modified	01/06/2015 DRP:  Added @customerStatus Filter
-- =============================================
CREATE PROCEDURE [dbo].[GetInvtMake4SoPrice]
