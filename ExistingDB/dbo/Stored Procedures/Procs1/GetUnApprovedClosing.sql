...
-- Description:	get generated auto closing JE that were not approved for a given period
-- =============================================
CREATE PROCEDURE [dbo].[GetUnApprovedClosing]
...
BEGIN
	...
	SELECT * from GLJEHDRO WHERE GLJEHDRO.FY =@cFy and GLJEHDRO.PERIOD =@nPeriod AND JETYPE ='CLOSE' AND STATUS='NOT APPROVED'
