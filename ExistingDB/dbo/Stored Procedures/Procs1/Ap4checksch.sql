...
-- =============================================
CREATE PROCEDURE [dbo].[Ap4checksch] 
	-- Add the parameters for the stored procedure here
	@gdToDate as char(10) = ' ', @gcBatchUniq as char(10) = ' ', @gcPaymentType varchar(50) = ' ', @gcFcused_uniq char(10) = ' '
AS
BEGIN
...
IF @gcFcused_uniq = ' '
	...
	AND Due_Date <= CAST(@gdToDate as smalldatetime) 
