...
-- Description:	procedure to get list of Closed or Cancelled Purchase Orders used for the report's parameters
-- Modifaction: 
-- =============================================
create PROCEDURE [dbo].[getParamsClosedCancelPO] 
...
BEGIN
    ...
    -- Insert statements for procedure here
   	if (@top is not null)
		...
		from	pomain 
		WHERE	POSTATUS in ('CLOSED','CANCELLED')
