...
-- Description:	procedure to get list of Open or Closed Purchase Orders used for the report's parameters
-- Modifaction: 
-- =============================================
create PROCEDURE [dbo].[getParamsOpenClosedPO] 
