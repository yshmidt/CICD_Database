...
-- =============================================
CREATE PROCEDURE [dbo].[GetLastNPoAvgCost] 
...
BEGIN
	...
	PartMfgr char(8),Costeach numeric(13,5),Ord_qty numeric(10,2),Podate SmallDateTime,Mfgr_pt_no char(30),
	...
	ELSE ISNULL(ROUND(TotalCost/TotalSQty,5),0.00) END FROM mWhtAvg
