...
-- Modification:
-- 05/22/15	VL	Converted from sp_GetOneInvMatlType because it could not used in SELECT command
-- Modified: 02/08/16 YS replace invtmfhd table with 2 new tables
-- =============================================
CREATE FUNCTION [dbo].[fn_GetOneInvMatlType] 
(
...
--02/08/16 YS replace invtmfhd table with 2 new tables
